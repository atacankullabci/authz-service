...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, UserAuthenticatedEvent> consumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, UserAuthenticatedEvent> kafkaListenerContainerFactory() {
